...
const Publications = () => {
    return (
        <div className='publications' id='publications'>
            ...
            <a href='https://www.facebook.com/photo?fbid=309670018352545&set=a.106364675349748&locale=ar_AR'> <div className='img5'></div></a>
            <a href='https://www.facebook.com/photo?fbid=312582664727947&set=a.106364675349748&locale=ar_AR'> <div className='img6'></div></a>
            </div>
